...
namespace SSData
{
    ...
    public class ConfigInfo
    {
        ...
        public bool USE_DEBUG_LOG { get; set; }
        public bool USE_REBOOT { get; set; }
        public string REBOOT_TIME { get; set; }
        public bool USE_SYNCTIME { get; set; }
        public string SYNC_URL { get; set; }
		public bool USE_LOCAL_MEDIAL { get; set; }
	}
}
