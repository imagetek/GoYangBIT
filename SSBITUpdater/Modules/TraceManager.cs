    ...
    public class TraceManager
    {
        ...
        public static void AddLog(string log)
        {
            ...
            try
            {
                ...
                string FILE_NM = System.IO.Path.Combine(기본DIR, string.Format("logUpdater_{0}.log", DateTime.Now.ToString("yyyyMMdd")));
        ...
        /// TTS log를 저장한다.
        /// </summary>
		public static void AddUpdaterLog(string log , bool UseDate = true)
        {
            System.Diagnostics.Debug.WriteLine(log);
            try
            {
                string 기본DIR = System.IO.Path.Combine(saveFolder, "LOG", "UPDATER");
                if (System.IO.Directory.Exists(기본DIR) == false) System.IO.Directory.CreateDirectory(기본DIR);
                ...
                string FILE_NM = System.IO.Path.Combine(일자DIR, string.Format("Updater _{0:d2}.log"
                    , DateTime.Now.Hour));
