...
{
	/// <summary>
	/// Interaction logic for wndTouchQuestionCheck.xaml
	/// </summary>
	public partial class wndTouchQuestionCheck : Window
	{
		private bool _isLoaded;
		private System.Windows.Point mousePoint;
		private Rectangle? _prevExtRect;

		public wndTouchQuestionCheck(string title, string message)
		{
		...
		private void btn취소_Click(object sender, RoutedEventArgs e)
		{
			try
			{
